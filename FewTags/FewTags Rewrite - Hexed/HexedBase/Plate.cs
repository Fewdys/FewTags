...
namespace FewTags
{
    ...
    internal class PlateStatic
    {
        ...
        public PlateStatic(VRC.Player __0, bool overlay)
        {
            ...
            _gameObjectID.transform.localPosition = new Vector3(0, Entry.PositionID, 0);
            ...
            _gameObjectM.transform.localPosition = new Vector3(0, Entry.Position, 0);
            ...
            _gameObjectBP.transform.localPosition = new Vector3(0, Entry.PositionBigText, 0);
